...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post tables_url, params: { table: { etc: @table.etc, post_id: @table.post_id, price: @table.price, title: @table.title } }
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { etc: @table.etc, post_id: @table.post_id, price: @table.price, title: @table.title } }
